...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Submenu; });\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance\"); }\n\nfunction _iterableToArray(iter) { if (Symbol.iterator in Object(iter) || Object.prototype.toString.call(iter) === \"[object Arguments]\") return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = new Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar Submenu =\n/*#__PURE__*/\nfunction () {\n  function Submenu() {\n    var _this = this;\n\n    _classCallCheck(this, Submenu);\n\n    this.navContainer = document.getElementById('site-navigation');\n    this.menuContainer = document.getElementById('primary-menu');\n    this.shadowRight = document.getElementById('menu-container-shadow-right');\n    this.shadowLeft = document.getElementById('menu-container-shadow-left');\n    this.init = this.init.bind(this);\n    this.setScrollPosition = this.setScrollPosition.bind(this);\n    this.breakpoint = window.matchMedia('( min-width: 1025px )');\n    this.intervalRight = '';\n    this.intervalLeft = '';\n    this.verticalScrollCapture = this.verticalScrollCapture.bind(this);\n    this.shadowElementScrollLeft = this.shadowElementScrollLeft.bind(this);\n    this.verticalScrollCapture();\n    this.init(this.menuContainer);\n    this.menuContainer.addEventListener('scroll', function () {\n      _this.setScrollPosition();\n    });\n    this.shadowRight.addEventListener('mouseover', function () {\n      _this.shadowElementScrollLeft();\n    });\n    this.shadowRight.addEventListener('mouseleave', function () {\n      clearInterval(_this.intervalRight);\n    });\n    this.shadowLeft.addEventListener('mouseover', function () {\n      _this.shadowElementScrollRight();\n    });\n    this.shadowLeft.addEventListener('mouseleave', function () {\n      clearInterval(_this.intervalLeft);\n    });\n  }\n\n  _createClass(Submenu, [{\n    key: \"init\",\n    value: function init(elem) {\n      if (elem.scrollWidth > elem.clientWidth) {\n        this.navContainer.classList.add('menu-scrollable');\n      }\n    }\n  }, {\n    key: \"setScrollPosition\",\n    value: function setScrollPosition() {\n      var _this2 = this;\n\n      var submenuItems = this.menuContainer.querySelectorAll(\".menu-item-has-children .sub-menu\");\n\n      if (!submenuItems) {\n        return;\n      }\n\n      if (!this.breakpoint.matches) {\n        _toConsumableArray(submenuItems).forEach(function (item) {\n          item.style.transform = \"translateX( 0 )\";\n        });\n\n        return;\n      }\n\n      _toConsumableArray(submenuItems).forEach(function (item) {\n        item.style.transform = \"translateX( -\".concat(_this2.menuContainer.scrollLeft, \"px )\");\n      });\n    }\n  }, {\n    key: \"verticalScrollCapture\",\n    value: function verticalScrollCapture() {\n      var _this3 = this;\n\n      this.menuContainer.addEventListener('wheel', function (e) {\n        if (e.deltaY !== 0) {\n          _this3.menuContainer.scrollLeft -= e.deltaY;\n          e.preventDefault();\n        }\n      });\n    }\n  }, {\n    key: \"shadowElementScrollLeft\",\n    value: function shadowElementScrollLeft() {\n      this.intervalRight = window.setInterval(this.animationIntervalLeft.bind(this), 25);\n    }\n  }, {\n    key: \"animationIntervalLeft\",\n    value: function animationIntervalLeft() {\n      this.menuContainer.scrollLeft += 1;\n    }\n  }, {\n    key: \"shadowElementScrollRight\",\n    value: function shadowElementScrollRight() {\n      this.intervalLeft = window.setInterval(this.animationIntervalRight.bind(this), 25);\n    }\n  }, {\n    key: \"animationIntervalRight\",\n    value: function animationIntervalRight() {\n      this.menuContainer.scrollLeft -= 1;\n    }\n  }]);\n\n  return Submenu;\n}();\n\n\n\n//# sourceURL=webpack:///./assets/src/js/submenu.js?");
