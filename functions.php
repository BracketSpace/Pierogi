...
if ( ! function_exists( 'pierogi_setup' ) ) :
	...
	function pierogi_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'pierogi_custom_background_args', array(
...
function pierogi_scripts() {
	wp_enqueue_style( 'pierogi-style', get_stylesheet_uri() );

	wp_enqueue_script( 'pierogi-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'pierogi-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
