...
<div class="search-form">
	<form method="GET" action="<?php echo esc_url( home_url( '/' ) ); ?>">
		<input class="search-input" type="text" name="s" placeholder="<?php esc_attr_e( 'Type words and hit enter', 'pierogi' ); ?>" value="<?php the_search_query(); ?>">
		<button class="btn-primary search-button" type="submit">
